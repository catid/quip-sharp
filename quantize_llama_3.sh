...
python -m quantize_llama.quantize_finetune_llama --save_path $CKPT/$RESULT --codebook $CODEBOOK  --scale_override 0.9 --base_model $BASE  --hessian_path $HESS/$RESULT/ --devset_size 384 --ft_valid_size 128 >> $LOG/$RESULT 2>&1
